...
# =====================================================
# AZURE GROUP MAPPING (ENV BASED)
# =====================================================

AZURE_GROUP_PRODUCT_SUPPORT_ADMIN = os.getenv("AZURE_GROUP_PRODUCT_SUPPORT_ADMIN")
AZURE_GROUP_SYSTEM_ADMIN = os.getenv("AZURE_GROUP_SYSTEM_ADMIN")
AZURE_GROUP_ORGANIZATION_ADMIN = os.getenv("AZURE_GROUP_ORGANIZATION_ADMIN")
AZURE_GROUP_MEMBER = os.getenv("AZURE_GROUP_MEMBER")


def map_azure_groups_to_role(groups: List[str]) -> str:
    """
    Maps Azure AD group IDs to internal roles.
    Priority-based mapping.
    """

    if AZURE_GROUP_PRODUCT_SUPPORT_ADMIN and AZURE_GROUP_PRODUCT_SUPPORT_ADMIN in groups:
        return PRODUCT_SUPPORT_ADMIN

    if AZURE_GROUP_SYSTEM_ADMIN and AZURE_GROUP_SYSTEM_ADMIN in groups:
        return SYSTEM_ADMIN

    if AZURE_GROUP_ORGANIZATION_ADMIN and AZURE_GROUP_ORGANIZATION_ADMIN in groups:
        return ORGANIZATION_ADMIN

    if AZURE_GROUP_MEMBER and AZURE_GROUP_MEMBER in groups:
        return MEMBER
